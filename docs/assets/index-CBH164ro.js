...
`);try{l=new Worker(URL.createObjectURL(new Blob([b])))}catch(y){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",y),null}f(l)}return l}}(),S={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function k(l,o){return o?o(l):l}function B(l){return l!=null}function v(l,o,g){return k(l&&B(l[o])?l[o]:S[o],g)}function W(l){return l<0?0:Math.floor(l)}function $(l,o){return Math.floor(Math.random()*(o-l))+l}function V(l){return parseInt(l,16)}function G(l){return l.map(oe)}function oe(l){var o=String(l).replace(/[^0-9a-f]/gi,"");return o.length<6&&(o=o[0]+o[0]+o[1]+o[1]+o[2]+o[2]),{r:V(o.substring(0,2)),g:V(o.substring(2,4)),b:V(o.substring(4,6))}}function le(l){var o=v(l,"origin",Object);return o.x=v(o,"x",Number),o.y=v(o,"y",Number),o}function ce(l){l.width=document.documentElement.clientWidth,l.height=document.documentElement.clientHeight}function de(l){var o=l.getBoundingClientRect();l.width=o.width,l.height=o.height}function he(l){var o=document.createElement("canvas");return o.style.position="fixed",o.style.top="0px",o.style.left="0px",o.style.pointerEvents="none",o.style.zIndex=l,o}function ue(l,o,g,f,b,y,w,m,x){l.save(),l.translate(o,g),l.rotate(y),l.scale(f,b),l.arc(0,0,1,w,m,x),l.restore()}function pe(l){var o=l.angle*(Math.PI/180),g=l.spread*(Math.PI/180);return{x:l.x,y:l.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:l.startVelocity*.5+Math.random()*l.startVelocity,angle2D:-o+(.5*g-Math.random()*g),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:l.color,shape:l.shape,tick:0,totalTicks:l.ticks,decay:l.decay,drift:l.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:l.gravity*3,ovalScalar:.6,scalar:l.scalar,flat:l.flat}}function ge(l,o){o.x+=Math.cos(o.angle2D)*o.velocity+o.drift,o.y+=Math.sin(o.angle2D)*o.velocity+o.gravity,o.velocity*=o.decay,o.flat?(o.wobble=0,o.wobbleX=o.x+10*o.scalar,o.wobbleY=o.y+10*o.scalar,o.tiltSin=0,o.tiltCos=0,o.random=1):(o.wobble+=o.wobbleSpeed,o.wobbleX=o.x+10*o.scalar*Math.cos(o.wobble),o.wobbleY=o.y+10*o.scalar*Math.sin(o.wobble),o.tiltAngle+=.1,o.tiltSin=Math.sin(o.tiltAngle),o.tiltCos=Math.cos(o.tiltAngle),o.random=Math.random()+2);var g=o.tick++/o.totalTicks,f=o.x+o.random*o.tiltCos,b=o.y+o.random*o.tiltSin,y=o.wobbleX+o.random*o.tiltCos,w=o.wobbleY+o.random*o.tiltSin;if(l.fillStyle="rgba("+o.color.r+", "+o.color.g+", "+o.color.b+", "+(1-g)+")",l.beginPath(),s&&o.shape.type==="path"&&typeof o.shape.path=="string"&&Array.isArray(o.shape.matrix))l.fill(fe(o.shape.path,o.shape.matrix,o.x,o.y,Math.abs(y-f)*.1,Math.abs(w-b)*.1,Math.PI/10*o.wobble));else if(o.shape.type==="bitmap"){var m=Math.PI/10*o.wobble,x=Math.abs(y-f)*.1,I=Math.abs(w-b)*.1,E=o.shape.bitmap.width*o.scalar,z=o.shape.bitmap.height*o.scalar,M=new DOMMatrix([Math.cos(m)*x,Math.sin(m)*x,-Math.sin(m)*I,Math.cos(m)*I,o.x,o.y]);M.multiplySelf(new DOMMatrix(o.shape.matrix));var R=l.createPattern(h.transform(o.shape.bitmap),"no-repeat");R.setTransform(M),l.globalAlpha=1-g,l.fillStyle=R,l.fillRect(o.x-E/2,o.y-z/2,E,z),l.globalAlpha=1}else if(o.shape==="circle")l.ellipse?l.ellipse(o.x,o.y,Math.abs(y-f)*o.ovalScalar,Math.abs(w-b)*o.ovalScalar,Math.PI/10*o.wobble,0,2*Math.PI):ue(l,o.x,o.y,Math.abs(y-f)*o.ovalScalar,Math.abs(w-b)*o.ovalScalar,Math.PI/10*o.wobble,0,2*Math.PI);else if(o.shape==="star")for(var L=Math.PI/2*3,q=4*o.scalar,N=8*o.scalar,H=o.x,_=o.y,K=5,F=Math.PI/K;K--;)H=o.x+Math.cos(L)*N,_=o.y+Math.sin(L)*N,l.lineTo(H,_),L+=F,H=o.x+Math.cos(L)*q,_=o.y+Math.sin(L)*q,l.lineTo(H,_),L+=F;else l.moveTo(Math.floor(o.x),Math.floor(o.y)),l.lineTo(Math.floor(o.wobbleX),Math.floor(b)),l.lineTo(Math.floor(y),Math.floor(w)),l.lineTo(Math.floor(f),Math.floor(o.wobbleY));return l.closePath(),l.fill(),o.tick<o.totalTicks}function me(l,o,g,f,b){var y=o.slice(),w=l.getContext("2d"),m,x,I=d(function(E){function z(){m=x=null,w.clearRect(0,0,f.width,f.height),h.clear(),b(),E()}function M(){i&&!(f.width===n.width&&f.height===n.height)&&(f.width=l.width=n.width,f.height=l.height=n.height),!f.width&&!f.height&&(g(l),f.width=l.width,f.height=l.height),w.clearRect(0,0,f.width,f.height),y=y.filter(function(R){return ge(w,R)}),y.length?m=p.frame(M):z()}m=p.frame(M),x=z});return{addFettis:function(E){return y=y.concat(E),I},canvas:l,promise:I,reset:function(){m&&p.cancel(m),x&&x()}}}function X(l,o){var g=!l,f=!!v(o||{},"resize"),b=!1,y=v(o,"disableForReducedMotion",Boolean),w=r&&!!v(o||{},"useWorker"),m=w?C():null,x=g?ce:de,I=l&&m?!!l.__confetti_initialized:!1,E=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,z;function M(L,q,N){for(var H=v(L,"particleCount",W),_=v(L,"angle",Number),K=v(L,"spread",Number),F=v(L,"startVelocity",Number),ye=v(L,"decay",Number),we=v(L,"gravity",Number),xe=v(L,"drift",Number),te=v(L,"colors",G),Se=v(L,"ticks",Number),ne=v(L,"shapes"),ke=v(L,"scalar"),Le=!!v(L,"flat"),ie=le(L),re=H,J=[],Te=l.width*ie.x,Ae=l.height*ie.y;re--;)J.push(pe({x:Te,y:Ae,angle:_,spread:K,startVelocity:F,color:te[re%te.length],shape:ne[$(0,ne.length)],ticks:Se,decay:ye,gravity:we,drift:xe,scalar:ke,flat:Le}));return z?z.addFettis(J):(z=me(l,J,x,q,N),z.promise)}function R(L){var q=y||v(L,"disableForReducedMotion",Boolean),N=v(L,"zIndex",Number);if(q&&E)return d(function(F){F()});g&&z?l=z.canvas:g&&!l&&(l=he(N),document.body.appendChild(l)),f&&!I&&x(l);var H={width:l.width,height:l.height};m&&!I&&m.init(l),I=!0,m&&(l.__confetti_initialized=!0);function _(){if(m){var F={getBoundingClientRect:function(){if(!g)return l.getBoundingClientRect()}};x(F),m.postMessage({resize:{width:F.width,height:F.height}});return}H.width=H.height=null}function K(){z=null,f&&(b=!1,e.removeEventListener("resize",_)),g&&l&&(document.body.contains(l)&&document.body.removeChild(l),l=null,I=!1)}return f&&!b&&(b=!0,e.addEventListener("resize",_,!1)),m?m.fire(L,H,K):M(L,H,K)}return R.reset=function(){m&&m.reset(),z&&z.reset()},R}var Q;function ee(){return Q||(Q=X(null,{useWorker:!0,resize:!0})),Q}function fe(l,o,g,f,b,y,w){var m=new Path2D(l),x=new Path2D;x.addPath(m,new DOMMatrix(o));var I=new Path2D;return I.addPath(x,new DOMMatrix([Math.cos(w)*b,Math.sin(w)*b,-Math.sin(w)*y,Math.cos(w)*y,g,f])),I}function ve(l){if(!s)throw new Error("path confetti are not supported in this browser");var o,g;typeof l=="string"?o=l:(o=l.path,g=l.matrix);var f=new Path2D(o),b=document.createElement("canvas"),y=b.getContext("2d");if(!g){for(var w=1e3,m=w,x=w,I=0,E=0,z,M,R=0;R<w;R+=2)for(var L=0;L<w;L+=2)y.isPointInPath(f,R,L,"nonzero")&&(m=Math.min(m,R),x=Math.min(x,L),I=Math.max(I,R),E=Math.max(E,L));z=I-m,M=E-x;var q=10,N=Math.min(q/z,q/M);g=[N,0,0,N,-Math.round(z/2+m)*N,-Math.round(M/2+x)*N]}return{type:"path",path:o,matrix:g}}function be(l){var o,g=1,f="#000000",b='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof l=="string"?o=l:(o=l.text,g="scalar"in l?l.scalar:g,b="fontFamily"in l?l.fontFamily:b,f="color"in l?l.color:f);var y=10*g,w=""+y+"px "+b,m=new OffscreenCanvas(y,y),x=m.getContext("2d");x.font=w;var I=x.measureText(o),E=Math.ceil(I.actualBoundingBoxRight+I.actualBoundingBoxLeft),z=Math.ceil(I.actualBoundingBoxAscent+I.actualBoundingBoxDescent),M=2,R=I.actualBoundingBoxLeft+M,L=I.actualBoundingBoxAscent+M;E+=M+M,z+=M+M,m=new OffscreenCanvas(E,z),x=m.getContext("2d"),x.font=w,x.fillStyle=f,x.fillText(o,R,L);var q=1/g;return{type:"bitmap",bitmap:m.transferToImageBitmap(),matrix:[q,0,0,q,-E*q/2,-z*q/2]}}t.exports=function(){return ee().apply(this,arguments)},t.exports.reset=function(){ee().reset()},t.exports.create=X,t.exports.shapeFromPath=ve,t.exports.shapeFromText=be})(function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}}(),Y,!1);const O=Y.exports;Y.exports.create;class Ne{constructor(e){this.container=e,this.currentLang=T.getLanguage(),this.loadLessons(),this.speechRate=1,this.isRecording=!1,this.recordStartTime=null,this.spokenTranscript="",this.selectedWordInfo=null,this.render(),this.bindEvents()}loadLessons(){const e=this.currentLang==="de"?De:Be,t=T.getCustomTexts().filter(i=>!i.lang||i.lang===this.currentLang);this.lessons=[...e,...t],this.currentLesson=this.lessons[0]||e[0]}setLanguage(e){this.currentLang=e,this.loadLessons(),this.selectedWordInfo=null,this.spokenTranscript="",this.render(),this.bindEvents()}refreshCustomLessons(){this.loadLessons(),this.updateLessonDropdown()}render(){const e=this.currentLang==="de";this.container.innerHTML=`
    ...
    `).join("")}updateLessonDropdown(){const e=this.container.querySelector("#lessonSelect");e&&(e.innerHTML=this.getLessonOptionsHtml())}getWordCount(){return this.currentLesson.text.trim().split(/\s+/).length}buildWordSpans(e){return e.trim().split(/\s+/).map((i,n)=>`<span class="word-token" data-index="${n}" data-word="${i}">${i}</span>`).join(" ")}bindEvents(){this.container.querySelector("#lessonSelect").addEventListener("change",d=>{this.switchLesson(d.target.value)});const t=this.container.querySelector("#readSpeedSlider"),i=this.container.querySelector("#speedValueLabel");t.addEventListener("input",d=>{this.speechRate=parseFloat(d.target.value),i.textContent=`${this.speechRate.toFixed(1)}x`}),this.container.querySelector("#listenCoachBtn").addEventListener("click",()=>{this.toggleListenCoach()}),this.container.querySelector("#resetReadBtn").addEventListener("click",()=>{this.resetHighlights()}),this.container.querySelector("#micRecordBtn").addEventListener("click",()=>{this.toggleSpeaking()}),this.container.querySelector("#readingTextViewport").addEventListener("click",d=>{const h=d.target.closest(".word-token");if(h){const p=h.dataset.word.replace(/[^\p{L}\p{N}]/gu,"");this.inspectWord(p)}}),this.container.querySelector("#openImportModalBtn").addEventListener("click",()=>{const d=document.querySelector("#customTextModal");d&&d.classList.add("open")})}switchLesson(e){u.stopSpeaking(),u.stopListening();const t=this.lessons.find(n=>n.id===e);if(!t)return;const i=this.currentLang==="de";this.currentLesson=t,this.container.querySelector("#lessonLevelBadge").textContent=t.level,this.container.querySelector("#lessonCatBadge").textContent=t.category,this.container.querySelector("#lessonTitle").textContent=t.title,this.container.querySelector("#wordCountBadge").textContent=`${this.getWordCount()} ${i?"Wörter":"words"}`,this.container.querySelector("#readingTextViewport").innerHTML=this.buildWordSpans(t.text),this.resetHighlights()}resetHighlights(){u.stopSpeaking();const e=this.currentLang==="de";this.container.querySelectorAll(".word-token").forEach(i=>{i.className="word-token"}),this.container.querySelector("#interimTranscriptText").textContent=e?'Klicken Sie auf "Sprechen starten" und lesen Sie laut vor...':'Click "Start Speaking" and read the text aloud clearly...',this.updateScoreView({accuracy:null,wpm:null,completeness:null,correct:0,hesitant:0})}toggleListenCoach(){const e=this.currentLang==="de",t=this.container.querySelector("#listenCoachBtnText");if(u.isSpeaking()){u.stopSpeaking(),t.textContent=e?"Coach anhören":"Listen to Coach",this.container.querySelectorAll(".word-token").forEach(r=>r.classList.remove("speaking-active"));return}this.resetHighlights(),t.textContent=e?"Audio stoppen":"Stop Listening";const i=Array.from(this.container.querySelectorAll(".word-token"));let n=0;u.speak({text:this.currentLesson.text,rate:this.speechRate,onBoundary:r=>{r.name==="word"&&(i.forEach(s=>s.classList.remove("speaking-active")),i[n]&&(i[n].classList.add("speaking-active"),n++))},onEnd:()=>{t.textContent=e?"Coach anhören":"Listen to Coach",i.forEach(r=>r.classList.remove("speaking-active"))},onError:()=>{t.textContent=e?"Coach anhören":"Listen to Coach",i.forEach(r=>r.classList.remove("speaking-active"))}})}startVisualizer(e){if(!e)return;this.stopVisualizer(e);const t=e.getContext("2d");let i=0;const n=()=>{if(!this.isRecording){this.stopVisualizer(e);return}t.clearRect(0,0,e.width,e.height);const r=t.createLinearGradient(0,0,e.width,0);r.addColorStop(0,"#06b6d4"),r.addColorStop(.5,"#6366f1"),r.addColorStop(1,"#ec4899"),t.lineWidth=3,t.strokeStyle=r,t.shadowBlur=8,t.shadowColor="#6366f1",t.beginPath();const s=e.width,c=e.height/2,d=this.spokenTranscript?16:8;for(let h=0;h<s;h+=4){const p=c+Math.sin(h*.04+i)*d*Math.sin(h/s*Math.PI);h===0?t.moveTo(h,p):t.lineTo(h,p)}t.stroke(),i+=.12,this.visualizerFrame=requestAnimationFrame(n)};n()}stopVisualizer(e){if(this.visualizerFrame&&(cancelAnimationFrame(this.visualizerFrame),this.visualizerFrame=null),e){const t=e.getContext("2d");t.clearRect(0,0,e.width,e.height),t.lineWidth=2,t.strokeStyle="rgba(99, 102, 241, 0.25)",t.beginPath(),t.moveTo(0,e.height/2),t.lineTo(e.width,e.height/2),t.stroke()}}async toggleSpeaking(){const e=this.currentLang==="de",t=this.container.querySelector("#micRecordBtn"),i=this.container.querySelector("#micRecordBtnText"),n=this.container.querySelector("#interimTranscriptText"),r=this.container.querySelector("#readWaveformCanvas");if(this.isRecording){this.isRecording=!1,t.classList.remove("recording"),i.textContent=e?"Sprechen starten":"Start Speaking",this.stopVisualizer(r),u.stopListening(),setTimeout(()=>{const s=(this.spokenTranscript||"").trim();s.length>0?this.finishEvaluation(s):n.textContent=e?"Aufnahme beendet. Keine Sprache erfasst.":"Recording stopped. No speech captured."},350);return}u.stopSpeaking(),this.resetHighlights(),this.hasEvaluated=!1,this.isRecording=!0,this.recordStartTime=Date.now(),this.spokenTranscript="",t.classList.add("recording"),i.textContent=e?"Stoppen & Auswerten":"Stop & Evaluate",n.textContent=e?"Höre zu... Jetzt sprechen.":"Listening... Speak now.";try{navigator.mediaDevices&&navigator.mediaDevices.getUserMedia&&(await navigator.mediaDevices.getUserMedia({audio:!0})).getTracks().forEach(a=>a.stop())}catch{alert(e?"Mikrofonzugriff ist erforderlich, um Ihre Sprache zu analysieren. Bitte erlauben Sie den Zugriff im Browser.":"Microphone access is required to analyze speaking. Please allow mic permission in your browser."),this.isRecording=!1,t.classList.remove("recording"),i.textContent=e?"Sprechen starten":"Start Speaking";return}this.startVisualizer(r),u.startListening({lang:u.getDefaultRecognitionLang(),continuous:!0,interimResults:!0,onInterim:({full:s})=>{this.spokenTranscript=s,n.textContent=s||(e?"Höre zu... Bitte deutlich sprechen.":"Listening... Speak clearly.")},onResult:s=>{const a=(s||this.spokenTranscript||"").trim();a.length>0&&this.finishEvaluation(a)},onError:s=>{console.warn("Speech recognition error:",s),(s&&(s.error||s.message))!=="no-speech"&&this.isRecording&&(this.spokenTranscript&&this.spokenTranscript.trim().length>3?this.finishEvaluation(this.spokenTranscript):(this.isRecording=!1,t.classList.remove("recording"),i.textContent=e?"Sprechen starten":"Start Speaking",this.stopVisualizer(r),n.textContent=e?'Keine Sprache erkannt oder Mikrofon unterbrochen. Bitte erneut auf "Sprechen starten" tippen.':'No speech caught or microphone interrupted. Please tap "Start Speaking" again.'))}})}finishEvaluation(e){if(this.hasEvaluated)return;this.hasEvaluated=!0;const t=this.currentLang==="de";this.isRecording=!1;const i=this.container.querySelector("#micRecordBtn"),n=this.container.querySelector("#micRecordBtnText"),r=this.container.querySelector("#readWaveformCanvas");i&&i.classList.remove("recording"),n&&(n.textContent=t?"Sprechen starten":"Start Speaking"),this.stopVisualizer(r);const s=Math.max(1,(Date.now()-(this.recordStartTime||Date.now()))/1e3),a=U.evaluateSpeech({referenceText:this.currentLesson.text,spokenText:e||"",durationSec:s}),c=this.container.querySelectorAll(".word-token");a.words.forEach((d,h)=>{c[h]&&(c[h].className=`word-token status-${d.status}`,c[h].title=`${t?"Gesprochen":"Spoken"}: "${d.spoken||(t?"ausgelassen":"omitted")}" (${d.similarity}% Match)`)}),this.updateScoreView({accuracy:a.accuracy,wpm:a.wordsPerMinute,completeness:a.completeness,correct:a.correctCount,hesitant:a.hesitantCount}),T.recordActivity({words:a.correctCount,minutes:Math.ceil(s/60),accuracy:a.accuracy}),a.accuracy>=85?(A.playChime("success"),O({particleCount:80,spread:60,origin:{y:.6}})):A.playChime("tap")}updateScoreView({accuracy:e,wpm:t,completeness:i,correct:n,hesitant:r}){const s=this.currentLang==="de",a=this.container.querySelector("#scoreCircle"),c=this.container.querySelector("#scoreNumber"),d=this.container.querySelector("#scoreGrade"),h=this.container.querySelector("#scoreFeedback"),p=this.container.querySelector("#metricWpm"),C=this.container.querySelector("#metricCompleteness"),S=this.container.querySelector("#metricCorrect"),k=this.container.querySelector("#metricHesitant");if(e===null){a.style.setProperty("--score-angle","0deg"),c.textContent="--",d.textContent=s?"Bereit zum Üben":"Ready to Practice",h.textContent=s?"Lesen Sie den Text laut vor für Ihre KI-Ausspracheauswertung.":"Read the text aloud to receive your AI speech assessment.",p.textContent="-- WPM",C.textContent="-- %",S.textContent="--",k.textContent="--";return}const B=e/100*360;a.style.setProperty("--score-angle",`${B}deg`),c.textContent=`${e}%`;let v=s?"Übung erforderlich":"Needs Practice",W=s?"Lesen Sie mit gleichmäßigem Tempo und sprechen Sie Konsonanten deutlich aus.":"Try reading at a steady pace and pronouncing each consonant clearly.";e>=90?(v=s?"🌟 Native Aussprache!":"🌟 Native-Like Fluency!",W=s?"Hervorragende Artikulation, Satzmelodie und Klarheit.":"Exceptional pronunciation, cadence, and word clarity."):e>=75?(v=s?"👍 Sehr guter Sprachfluss!":"👍 Great Flow!",W=s?"Starke Aussprache. Achten Sie auf die hervorgehobenen Wörter.":"Solid pronunciation. Focus on the underlined words to reach 90%+."):e>=55&&(v=s?"Guter Versuch":"Good Effort",W=s?"Hören Sie den Coach bei 0.8x Tempo an und sprechen Sie synchron mit.":"Listen to the Coach once at 0.8x speed, then shadow along."),d.textContent=v,h.textContent=W,p.textContent=`${t} WPM`,C.textContent=`${i}%`,S.textContent=`${n}`,k.textContent=`${r}`}inspectWord(e){const t=this.currentLang==="de",i=e.toLowerCase(),r=(this.currentLesson.vocabulary||[]).find(p=>p.word.toLowerCase()===i),s=r?r.ipa:"",a=r?r.def:t?"Lesen und artikulieren Sie dieses Wort laut und präzise.":"Practice reading and articulating this word clearly.",c=T.isWordSaved(i),d=this.container.querySelector("#inspectorContent");d.innerHTML=`
    ...
    `,d.querySelector("#inspectAudioBtn").addEventListener("click",()=>{u.speak({text:e,rate:.85})});const h=d.querySelector("#saveWordVaultBtn");h.addEventListener("click",()=>{T.saveToVault({word:e,ipa:s,def:a,example:`${t?"Aus":"From"} "${this.currentLesson.title}"`}),h.textContent=t?"✓ Im Tresor gespeichert":"✓ Saved in Vault",h.classList.replace("btn-primary","btn-secondary"),A.playChime("tap")}),u.speak({text:e,rate:.9})}}class He{constructor(e){this.container=e,this.currentLang=T.getLanguage(),this.loadLessons(),this.currentLessonIdx=0,this.currentSentenceIdx=0,this.isRecording=!1,this.userAudioUrl=null,this.render(),this.bindEvents()}loadLessons(){this.lessons=this.currentLang==="de"?Pe:Ee}setLanguage(e){this.currentLang=e,this.loadLessons(),this.currentLessonIdx=0,this.currentSentenceIdx=0,this.userAudioUrl=null,this.render(),this.bindEvents()}getCurrentLesson(){return this.lessons[this.currentLessonIdx]}getCurrentSentence(){return this.getCurrentLesson().sentences[this.currentSentenceIdx]}render(){const e=this.currentLang==="de",t=this.getCurrentLesson(),i=this.getCurrentSentence(),n=t.sentences.length;this.container.innerHTML=`
      <div class="section-header">
        <div class="section-title-wrap">
    ...
    `;const r=this.container.querySelector("#chatConversation");r&&(r.scrollTop=r.scrollHeight)}bindEvents(){const e=this.container.querySelector("#roleplaySelect");e&&e.addEventListener("change",a=>{this.currentScenarioIdx=parseInt(a.target.value),this.initScenario(),this.render(),this.bindEvents()});const t=this.container.querySelector("#restartScenarioBtn");t&&t.addEventListener("click",()=>{this.initScenario(),this.render(),this.bindEvents()});const i=this.container.querySelector("#restartCompletedBtn");i&&i.addEventListener("click",()=>{this.initScenario(),this.render(),this.bindEvents()}),this.container.querySelectorAll(".replay-ai-speech").forEach(a=>{a.addEventListener("click",c=>{const d=decodeURIComponent(c.currentTarget.dataset.text);u.speak({text:d,rate:.95})})}),this.container.querySelectorAll(".speak-sample-btn").forEach(a=>{a.addEventListener("click",c=>{c.stopPropagation();const d=decodeURIComponent(c.currentTarget.dataset.text);u.speak({text:d,rate:.9})})}),this.container.querySelectorAll(".suggested-reply-card").forEach(a=>{a.addEventListener("click",()=>{const c=decodeURIComponent(a.dataset.text);this.activeSelectedPrompt=c;const d=this.container.querySelector("#roleplayCustomInput");d&&(d.value=c),this.render(),this.bindEvents()})});const n=this.container.querySelector("#roleplayCustomInput"),r=this.container.querySelector("#roleplaySendBtn");if(n&&r){const a=()=>{const c=n.value.trim();c&&this.handleUserSpokenReply(c)};r.addEventListener("click",a),n.addEventListener("keydown",c=>{c.key==="Enter"&&!c.isComposing&&c.keyCode!==229&&(c.preventDefault(),a())})}const s=this.container.querySelector("#roleplayMicBtn");s&&s.addEventListener("click",()=>{this.toggleRoleplaySpeaking()})}toggleRoleplaySpeaking(){const e=this.currentLang==="de",t=this.container.querySelector("#roleplayMicBtn"),i=this.container.querySelector("#roleplayMicText"),n=this.container.querySelector("#roleplayInterim");if(this.isListening){this.isListening=!1,t.classList.remove("recording"),i.textContent=e?"Antwort sprechen":"Speak Response",u.stopListening();return}this.isListening=!0,t.classList.add("recording"),i.textContent=e?"Höre...":"Listening...",n.textContent=e?"Höre zu... Bitte sprechen.":"Listening... Speak now.";let r="";u.startListening({lang:u.getDefaultRecognitionLang(),continuous:!0,interimResults:!0,onInterim:({full:s})=>{r=s,n.textContent=s;const a=this.container.querySelector("#roleplayCustomInput");a&&(a.value=s)},onResult:s=>{const a=s||r,c=this.container.querySelector("#roleplayCustomInput");c&&a&&(c.value=a),this.handleUserSpokenReply(a)},onError:()=>{this.isListening=!1,t.classList.remove("recording"),i.textContent=e?"Sprechen":"Speak"}})}handleUserSpokenReply(e){const t=this.currentLang==="de";this.isListening=!1;const i=this.container.querySelector("#roleplayMicBtn"),n=this.container.querySelector("#roleplayMicText");i&&i.classList.remove("recording"),n&&(n.textContent=t?"Sprechen":"Speak");const r=(e||"").trim()||(this.activeSelectedPrompt||"").trim();if(!r){const a=this.container.querySelector("#roleplayInterim");a&&(a.textContent=t?"Keine Sprache erkannt. Bitte tippen Sie eine Antwort oder wählen Sie eine Vorlage.":"No speech caught. Please type your response or select a suggested option.");return}this.chatHistory.push({sender:"user",speaker:t?"Sie":"You",avatar:"🗣️",text:r}),A.playChime("tap"),this.activeSelectedPrompt="",this.currentStepIdx++;const s=this.getCurrentScenario();if(this.currentStepIdx<s.steps.length){const a=s.steps[this.currentStepIdx];setTimeout(()=>{this.chatHistory.push({sender:"ai",speaker:a.speaker,avatar:a.avatar,text:a.aiSpeech}),this.render(),this.bindEvents(),u.speak({text:a.aiSpeech,rate:.95})},600)}else setTimeout(()=>{this.render(),this.bindEvents(),O({particleCount:70,spread:60}),A.playChime("success")},400);T.recordActivity({words:r.split(" ").length,accuracy:90}),this.render(),this.bindEvents()}}class Ge{constructor(e){this.container=e,this.currentLang=T.getLanguage(),this.loadDrills(),this.activeTab="minimalPairs",this.selectedPairCategoryIdx=0,this.activeTestingPair=null,this.isTestingPair=!1,this.isRecordingTwister=!1,this.activeTwisterIdx=0,this.render(),this.bindEvents()}loadDrills(){this.drills=this.currentLang==="de"?Ve:Re}setLanguage(e){this.currentLang=e,this.loadDrills(),this.selectedPairCategoryIdx=0,this.activeTwisterIdx=0,this.render(),this.bindEvents()}render(){const e=this.currentLang==="de";this.container.innerHTML=`
      <div class="section-header">
        <div class="section-title-wrap">
          ...
          <div class="card-header-bar" style="border-bottom: 1px solid var(--border-glass); padding-bottom: 14px; margin-bottom: 16px;">
            ...
            <div style="display: flex; align-items: center; gap: 8px;">
              <select id="vocScenarioPicker" class="btn btn-secondary btn-sm" style="background: rgba(20,28,48,0.9); color: white;">
                ${t.map((s,a)=>`
                  <option value="${a}" ${a===this.scenarioIdx?"selected":""}>${s.title}</option>
                `).join("")}
              </select>
          ...
          ${!r&&n?`
            <div class="voc-reply-box" style="margin-top: 14px; border-top: 1px solid var(--border-glass); padding-top: 14px;">
              ...
              <div style="display: flex; flex-direction: column; gap: 8px; margin-bottom: 14px;">
                ${n.suggestedResponses.map((s,a)=>`
                  <div class="suggested-reply-card voc-suggested-card ${this.activeSelectedPrompt===s?"active-prompt":""}" data-idx="${a}" data-text="${encodeURIComponent(s)}">
    ...
    `}renderVocabMode(){const e=this.currentLang==="de",t=Ue[this.currentDomain]||[],i=t.filter(r=>{const s=this.vocabSearch.toLowerCase(),a=!s||r.termDe.toLowerCase().includes(s)||r.termEn.toLowerCase().includes(s)||r.defAr.includes(s)||r.category.toLowerCase().includes(s),c=this.selectedCategory==="all"||r.category===this.selectedCategory;return a&&c}),n=["all",...new Set(t.map(r=>r.category))];return`
    ...
    `}renderQuizMode(){const e=this.currentLang==="de",i=(Z[this.currentLang]||Z.de).filter(r=>r.domain===this.currentDomain),n=i[this.quizIdx]||i[0];return n?`
      <div class="voc-quiz-studio glass-panel" style="padding: 24px; max-width: 820px; margin: 0 auto;">
        ...
        <div style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 20px;">
          ${n.options.map((r,s)=>{let a="";return this.quizSubmitted?s===n.correctIdx?a="correct-opt":this.selectedQuizOption===s&&(a="wrong-opt"):this.selectedQuizOption===s&&(a="selected-opt"),`
              <div class="voc-quiz-option ${a}" data-idx="${s}">
    ...
    `:'<div class="card glass-panel" style="padding: 24px; text-align: center;">Keine Quizfragen für diese Auswahl vorhanden.</div>'}bindEvents(){const e=this.container.querySelector("#vocArabicToggle");e&&e.addEventListener("click",()=>{this.showArabic=!this.showArabic,this.render(),this.bindEvents()});const t=this.container.querySelector("#vocLevelSelect");t&&t.addEventListener("change",r=>{this.currentLevel=r.target.value,this.render(),this.bindEvents()}),this.container.querySelectorAll(".voc-domain-btn").forEach(r=>{r.addEventListener("click",()=>{const s=r.dataset.domain;s!==this.currentDomain&&(this.currentDomain=s,this.scenarioIdx=0,this.stepIdx=0,this.quizIdx=0,this.selectedQuizOption=null,this.quizSubmitted=!1,this.initRoleplay(),this.render(),this.bindEvents())})}),this.container.querySelectorAll(".voc-mode-tab").forEach(r=>{r.addEventListener("click",()=>{const s=r.dataset.mode;s!==this.currentMode&&(u.stopSpeaking(),u.stopListening(),this.currentMode=s,this.render(),this.bindEvents())})}),this.bindRoleplayEvents(),this.bindVocabEvents(),this.bindPolishEvents(),this.bindQuizEvents()}bindRoleplayEvents(){const e=this.container.querySelector("#vocScenarioPicker");e&&e.addEventListener("change",d=>{this.scenarioIdx=parseInt(d.target.value,10),this.initRoleplay(),this.render(),this.bindEvents()});const t=this.container.querySelector("#vocRestartBtn");t&&t.addEventListener("click",()=>{this.initRoleplay(),this.render(),this.bindEvents()}),this.container.querySelectorAll(".voc-replay-btn, .voc-preview-audio-btn, .voc-speak-vocab-btn").forEach(d=>{d.addEventListener("click",h=>{h.stopPropagation();const p=decodeURIComponent(d.dataset.text);u.speak({text:p,rate:.95})})});const n=this.container.querySelectorAll(".voc-suggested-card");n.forEach(d=>{d.addEventListener("click",()=>{const h=decodeURIComponent(d.dataset.text);this.activeSelectedPrompt=h;const p=this.container.querySelector("#vocCustomReplyInput");p&&(p.value=h),n.forEach(C=>C.classList.remove("active-prompt")),d.classList.add("active-prompt")})});const r=this.container.querySelector("#vocSendReplyBtn"),s=this.container.querySelector("#vocCustomReplyInput");if(r&&s){const d=()=>{const h=s.value.trim();h&&this.processUserReply(h)};r.addEventListener("click",d),s.addEventListener("keydown",h=>{h.key==="Enter"&&!h.isComposing&&h.keyCode!==229&&(h.preventDefault(),d())})}const a=this.container.querySelector("#vocMicBtn");a&&a.addEventListener("click",()=>{this.isListening?(u.stopListening(),this.isListening=!1,a.classList.remove("btn-danger","pulse"),a.innerHTML="🎙️ Sprechen"):(u.startListening({onInterim:({full:d})=>{s&&(s.value=d)},onResult:d=>{s&&(s.value=d),this.activeSelectedPrompt=d},onEnd:()=>{this.isListening=!1,a&&(a.classList.remove("btn-danger","pulse"),a.innerHTML="🎙️ Sprechen")},onError:d=>{console.warn("SpeechRecognition error:",d),this.isListening=!1,a&&(a.classList.remove("btn-danger","pulse"),a.innerHTML="🎙️ Sprechen")}}),this.isListening=!0,a.classList.add("btn-danger","pulse"),a.innerHTML="🔴 Höre...")});const c=this.container.querySelector("#vocNextScenarioBtn");c&&c.addEventListener("click",()=>{const d=this.getScenarios();this.scenarioIdx=(this.scenarioIdx+1)%d.length,this.initRoleplay(),this.render(),this.bindEvents()})}processUserReply(e){if(this.isListening){u.stopListening(),this.isListening=!1;const s=this.container.querySelector("#vocMicBtn");s&&(s.classList.remove("btn-danger","pulse"),s.innerHTML="🎙️ Sprechen")}const t=this.getCurrentStep();if(!t)return;const i=e.split(/\s+/).filter(Boolean).length;T.incrementWordCount(i),this.chatHistory.push({sender:"user",speaker:"Sie (You)",avatar:"👤",text:e,feedback:t.feedback}),A.playChime("success"),this.activeSelectedPrompt="",this.stepIdx++;const n=this.getCurrentStep();n?setTimeout(()=>{this.chatHistory.push({sender:"ai",speaker:n.speaker,avatar:n.avatar,text:n.aiSpeech}),this.render(),this.bindEvents(),setTimeout(()=>{u.speak({text:n.aiSpeech,rate:.95})},300)},700):setTimeout(()=>{O({particleCount:75,spread:60,origin:{y:.7}}),this.render(),this.bindEvents()},500),this.render(),this.bindEvents();const r=this.container.querySelector("#vocChatStream");r&&(r.scrollTop=r.scrollHeight)}bindVocabEvents(){const e=this.container.querySelector("#vocVocabSearchInput");e&&e.addEventListener("input",n=>{if(this.vocabSearch=n.target.value,this.container.querySelector(".voc-vocab-grid")){const s=this.container.querySelector(".voc-mode-viewport");s&&(s.innerHTML=this.renderVocabMode()),this.bindVocabEvents()}}),this.container.querySelectorAll(".voc-cat-pill").forEach(n=>{n.addEventListener("click",()=>{this.selectedCategory=n.dataset.cat;const r=this.container.querySelector(".voc-mode-viewport");r&&(r.innerHTML=this.renderVocabMode()),this.bindVocabEvents()})}),this.container.querySelectorAll(".voc-add-to-vault-btn").forEach(n=>{n.addEventListener("click",r=>{r.stopPropagation();const s=decodeURIComponent(n.dataset.word),a=decodeURIComponent(n.dataset.ipa),c=decodeURIComponent(n.dataset.def);T.saveVaultWord({word:s,ipa:a,definition:c,lang:this.currentLang}),A.playChime("chime"),n.textContent="✅ Gespeichert!",n.style.borderColor="#10b981",n.style.color="#34d399",setTimeout(()=>{n.textContent="⭐ Im Wortschatz-Vault speichern"},2e3)})})}bindPolishEvents(){const e=this.container.querySelectorAll(".voc-polish-preset-btn"),t=this.container.querySelector("#vocPolishTextarea"),n=(j[this.currentLang]||j.de).filter(a=>a.domain===this.currentDomain);e.forEach(a=>{a.addEventListener("click",()=>{this.polishPresetIdx=parseInt(a.dataset.idx,10);const c=n[this.polishPresetIdx];c&&t&&(t.value=c.rawDraft),e.forEach(h=>h.classList.replace("badge-accent","badge-level")),a.classList.replace("badge-level","badge-accent");const d=this.container.querySelector("#vocPolishResultCard");d&&(d.innerHTML=this.renderActivePolishCard(c)),this.bindRoleplayEvents()})});const r=this.container.querySelector("#vocRunPolishBtn");r&&t&&r.addEventListener("click",()=>{if(this.isListening){u.stopListening(),this.isListening=!1;const d=this.container.querySelector("#vocPolishMicBtn");d&&(d.classList.remove("btn-danger","pulse"),d.innerHTML="🎙️ Diktieren")}const a=t.value.trim();if(!a)return;const c=this.container.querySelector("#vocPolishResultCard");if(c){const d={title:"Benutzerdefinierter Entwurf",rawDraft:a,polished:a,diffNotes:["Eigener Text übernommen - Struktur und Tonfall für den Berufsalltag validiert."],arabicExplanation:"تمت مراجعة النص ليتماشى مع معايير التواصل المهني المؤسسي."};A.playChime("success"),c.innerHTML=this.renderActivePolishCard(d),this.bindRoleplayEvents()}});const s=this.container.querySelector("#vocPolishMicBtn");s&&t&&s.addEventListener("click",()=>{this.isListening?(u.stopListening(),this.isListening=!1,s.classList.remove("btn-danger","pulse"),s.innerHTML="🎙️ Diktieren"):(u.startListening({onInterim:({full:a})=>{t.value=a},onResult:a=>{t.value=a},onEnd:()=>{this.isListening=!1,s&&(s.classList.remove("btn-danger","pulse"),s.innerHTML="🎙️ Diktieren")}}),this.isListening=!0,s.classList.add("btn-danger","pulse"),s.innerHTML="🔴 Höre...")})}bindQuizEvents(){const t=(Z[this.currentLang]||Z.de).filter(a=>a.domain===this.currentDomain),i=t[this.quizIdx]||t[0],n=this.container.querySelectorAll(".voc-quiz-option");n.forEach(a=>{a.addEventListener("click",()=>{if(this.quizSubmitted)return;this.selectedQuizOption=parseInt(a.dataset.idx,10),n.forEach(d=>d.classList.remove("selected-opt")),a.classList.add("selected-opt");const c=this.container.querySelector("#vocQuizSubmitBtn");c&&(c.removeAttribute("disabled"),c.style.opacity="1")})});const r=this.container.querySelector("#vocQuizSubmitBtn");r&&r.addEventListener("click",()=>{if(this.selectedQuizOption===null||this.quizSubmitted)return;this.quizSubmitted=!0,i&&this.selectedQuizOption===i.correctIdx?(A.playChime("success"),O({particleCount:50,spread:50,origin:{y:.6}})):A.playChime("alert");const a=this.container.querySelector(".voc-mode-viewport");a&&(a.innerHTML=this.renderQuizMode()),this.bindQuizEvents()});const s=this.container.querySelector("#vocQuizNextBtn");s&&s.addEventListener("click",()=>{this.quizIdx=(this.quizIdx+1)%t.length,this.selectedQuizOption=null,this.quizSubmitted=!1;const a=this.container.querySelector(".voc-mode-viewport");a&&(a.innerHTML=this.renderQuizMode()),this.bindQuizEvents()})}}class je{constructor(e){this.container=e,this.currentLang=T.getLanguage(),this.searchQuery="",this.render(),this.bindEvents()}setLanguage(e){this.currentLang=e,this.render(),this.bindEvents()}render(){const e=this.currentLang==="de",t=T.getStats(),i=T.getStreak();let n=T.getVault();if(this.searchQuery.trim()){const r=this.searchQuery.toLowerCase();n=n.filter(s=>s.word.toLowerCase().includes(r)||s.def&&s.def.toLowerCase().includes(r))}this.container.innerHTML=`
      <div class="section-header">
        <div class="section-title-wrap">
    ...
    `,document.querySelector(".app-container").insertBefore(t,document.getElementById("mainNavTabs"))}setupLanguageSwitcher(){const e=document.getElementById("btnLangEn"),t=document.getElementById("btnLangDe"),i=n=>{e&&e.classList.toggle("active",n==="en"),t&&t.classList.toggle("active",n==="de")};i(this.currentLang),e&&e.addEventListener("click",()=>{this.currentLang!=="en"&&(this.switchLanguage("en"),i("en"))}),t&&t.addEventListener("click",()=>{this.currentLang!=="de"&&(this.switchLanguage("de"),i("de"))})}switchLanguage(e){this.currentLang=e,T.setLanguage(e),u.stopSpeaking(),u.stopListening(),A.stopRecording(),u.setLanguage(e),this.populateVoices(),this.modules.read&&this.modules.read.setLanguage(e),this.modules.shadow&&this.modules.shadow.setLanguage(e),this.modules.dict&&this.modules.dict.setLanguage(e),this.modules.roleplay&&this.modules.roleplay.setLanguage(e),this.modules.phonetics&&this.modules.phonetics.setLanguage(e),this.modules.vocational&&this.modules.vocational.setLanguage(e),this.modules.vault&&this.modules.vault.setLanguage(e),this.applyLanguageUI(e),this.updateHeaderStats();const t=document.getElementById("browserWarningBanner");t&&(t.remove(),this.showBrowserNotice()),A.playChime("tap")}applyLanguageUI(e){const t=se[e]||se.en,i=document.getElementById("brandSubtitle");i&&(i.textContent=t.brandSubtitle);const n=document.getElementById("voiceSelectLabel");n&&(n.textContent=t.voiceLabel);const r=document.getElementById("headerInstallText");r&&t.installBtn&&(r.textContent=t.installBtn);const s=document.querySelector("#navTabRead .tab-label");s&&(s.textContent=t.nav.read);const a=document.querySelector("#navTabShadow .tab-label");a&&(a.textContent=t.nav.shadow);const c=document.querySelector("#navTabDict .tab-label");c&&(c.textContent=t.nav.dict);const d=document.querySelector("#navTabRoleplay .tab-label");d&&(d.textContent=t.nav.roleplay);const h=document.querySelector("#navTabPhonetics .tab-label");h&&(h.textContent=t.nav.phonetics);const p=document.querySelector("#navTabVocational .tab-label");p&&t.nav.vocational&&(p.textContent=t.nav.vocational);const C=document.querySelector("#navTabVault .tab-label");C&&(C.textContent=t.nav.vault);const S=document.getElementById("modalTitle");S&&(S.textContent=t.modal.title);const k=document.getElementById("modalDesc");k&&(k.textContent=t.modal.desc);const B=document.getElementById("modalTitleLabel");B&&(B.textContent=t.modal.articleTitleLabel);const v=document.getElementById("customTextTitleInput");v&&(v.placeholder=t.modal.articleTitlePlaceholder);const W=document.getElementById("modalTextLabel");W&&(W.textContent=t.modal.textLabel);const $=document.getElementById("customTextareaInput");$&&($.placeholder=t.modal.textPlaceholder);const V=document.getElementById("cancelModalBtn");V&&(V.textContent=t.modal.cancelBtn);const G=document.getElementById("saveCustomTextBtn");G&&(G.textContent=t.modal.saveBtn)}setupNavigation(){const e=document.querySelectorAll(".tab-btn"),t=document.querySelectorAll(".module-view");e.forEach(i=>{i.addEventListener("click",()=>{const n=i.dataset.target;n!==this.activeTab&&(u.stopSpeaking(),u.stopListening(),A.stopRecording(),e.forEach(r=>r.classList.remove("active")),i.classList.add("active"),t.forEach(r=>{r.id===n?r.classList.add("active"):r.classList.remove("active")}),this.activeTab=n,n==="vaultModule"&&this.modules.vault&&(this.modules.vault.render(),this.modules.vault.bindEvents()),this.updateHeaderStats())})})}setupVoicePicker(){const e=document.getElementById("globalVoiceSelect");this.populateVoices=()=>{const t=u.getAvailableVoices();!t||t.length===0||(e.innerHTML=t.map(i=>`
      ...
      `).join(""))},this.populateVoices(),window.speechSynthesis&&(window.speechSynthesis.onvoiceschanged=()=>{u.initVoices(),this.populateVoices()}),e.addEventListener("change",t=>{u.setVoiceByUri(t.target.value),T.saveSettings({preferredVoice:t.target.value})})}updateHeaderStats(){const e=T.getStreak(),t=T.getStats(),i=this.currentLang==="de",n=document.getElementById("headerStreakVal"),r=document.getElementById("headerWordsVal");if(n){const s=i?e.currentStreak===1?"Tag Serie":"Tage Serie":(e.currentStreak===1,"Day Streak");n.textContent=`${e.currentStreak} ${s}`}if(r){const s=i?"Gesprochen":"Spoken";r.textContent=`${t.wordsSpoken} ${s}`}}setupCustomTextModal(){const e=document.getElementById("customTextModal"),t=document.getElementById("closeModalBtn"),i=document.getElementById("cancelModalBtn"),n=document.getElementById("saveCustomTextBtn"),r=document.getElementById("customTextTitleInput"),s=document.getElementById("customTextareaInput"),a=()=>{e.classList.remove("open"),r.value="",s.value=""};t.addEventListener("click",a),i.addEventListener("click",a),e.addEventListener("click",c=>{c.target===e&&a()}),n.addEventListener("click",()=>{const c=s.value.trim(),d=this.currentLang==="de"?"Mein eigener Übungstext":"My Custom Practice Article",h=r.value.trim()||d;if(!c){const C=this.currentLang==="de"?"Bitte fügen Sie einen Text zum Üben ein.":"Please paste some text to practice.";alert(C);return}const p=T.saveCustomText({title:h,text:c,lang:this.currentLang});a(),this.modules.read&&(this.modules.read.refreshCustomLessons(),this.modules.read.switchLesson(p.id)),document.querySelector('[data-target="readModule"]').click(),A.playChime("success")})}}document.addEventListener("DOMContentLoaded",()=>{window.echoSpeakApp=new Qe});
