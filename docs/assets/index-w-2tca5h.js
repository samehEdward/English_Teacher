...
`);try{c=new Worker(URL.createObjectURL(new Blob([b])))}catch(y){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",y),null}f(c)}return c}}(),S={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function k(c,o){return o?o(c):c}function B(c){return c!=null}function v(c,o,g){return k(c&&B(c[o])?c[o]:S[o],g)}function W(c){return c<0?0:Math.floor(c)}function R(c,o){return Math.floor(Math.random()*(o-c))+c}function V(c){return parseInt(c,16)}function G(c){return c.map(oe)}function oe(c){var o=String(c).replace(/[^0-9a-f]/gi,"");return o.length<6&&(o=o[0]+o[0]+o[1]+o[1]+o[2]+o[2]),{r:V(o.substring(0,2)),g:V(o.substring(2,4)),b:V(o.substring(4,6))}}function le(c){var o=v(c,"origin",Object);return o.x=v(o,"x",Number),o.y=v(o,"y",Number),o}function ce(c){c.width=document.documentElement.clientWidth,c.height=document.documentElement.clientHeight}function de(c){var o=c.getBoundingClientRect();c.width=o.width,c.height=o.height}function he(c){var o=document.createElement("canvas");return o.style.position="fixed",o.style.top="0px",o.style.left="0px",o.style.pointerEvents="none",o.style.zIndex=c,o}function ue(c,o,g,f,b,y,w,m,x){c.save(),c.translate(o,g),c.rotate(y),c.scale(f,b),c.arc(0,0,1,w,m,x),c.restore()}function pe(c){var o=c.angle*(Math.PI/180),g=c.spread*(Math.PI/180);return{x:c.x,y:c.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:c.startVelocity*.5+Math.random()*c.startVelocity,angle2D:-o+(.5*g-Math.random()*g),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:c.color,shape:c.shape,tick:0,totalTicks:c.ticks,decay:c.decay,drift:c.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:c.gravity*3,ovalScalar:.6,scalar:c.scalar,flat:c.flat}}function ge(c,o){o.x+=Math.cos(o.angle2D)*o.velocity+o.drift,o.y+=Math.sin(o.angle2D)*o.velocity+o.gravity,o.velocity*=o.decay,o.flat?(o.wobble=0,o.wobbleX=o.x+10*o.scalar,o.wobbleY=o.y+10*o.scalar,o.tiltSin=0,o.tiltCos=0,o.random=1):(o.wobble+=o.wobbleSpeed,o.wobbleX=o.x+10*o.scalar*Math.cos(o.wobble),o.wobbleY=o.y+10*o.scalar*Math.sin(o.wobble),o.tiltAngle+=.1,o.tiltSin=Math.sin(o.tiltAngle),o.tiltCos=Math.cos(o.tiltAngle),o.random=Math.random()+2);var g=o.tick++/o.totalTicks,f=o.x+o.random*o.tiltCos,b=o.y+o.random*o.tiltSin,y=o.wobbleX+o.random*o.tiltCos,w=o.wobbleY+o.random*o.tiltSin;if(c.fillStyle="rgba("+o.color.r+", "+o.color.g+", "+o.color.b+", "+(1-g)+")",c.beginPath(),r&&o.shape.type==="path"&&typeof o.shape.path=="string"&&Array.isArray(o.shape.matrix))c.fill(fe(o.shape.path,o.shape.matrix,o.x,o.y,Math.abs(y-f)*.1,Math.abs(w-b)*.1,Math.PI/10*o.wobble));else if(o.shape.type==="bitmap"){var m=Math.PI/10*o.wobble,x=Math.abs(y-f)*.1,I=Math.abs(w-b)*.1,E=o.shape.bitmap.width*o.scalar,z=o.shape.bitmap.height*o.scalar,M=new DOMMatrix([Math.cos(m)*x,Math.sin(m)*x,-Math.sin(m)*I,Math.cos(m)*I,o.x,o.y]);M.multiplySelf(new DOMMatrix(o.shape.matrix));var $=c.createPattern(d.transform(o.shape.bitmap),"no-repeat");$.setTransform(M),c.globalAlpha=1-g,c.fillStyle=$,c.fillRect(o.x-E/2,o.y-z/2,E,z),c.globalAlpha=1}else if(o.shape==="circle")c.ellipse?c.ellipse(o.x,o.y,Math.abs(y-f)*o.ovalScalar,Math.abs(w-b)*o.ovalScalar,Math.PI/10*o.wobble,0,2*Math.PI):ue(c,o.x,o.y,Math.abs(y-f)*o.ovalScalar,Math.abs(w-b)*o.ovalScalar,Math.PI/10*o.wobble,0,2*Math.PI);else if(o.shape==="star")for(var L=Math.PI/2*3,q=4*o.scalar,N=8*o.scalar,F=o.x,_=o.y,K=5,H=Math.PI/K;K--;)F=o.x+Math.cos(L)*N,_=o.y+Math.sin(L)*N,c.lineTo(F,_),L+=H,F=o.x+Math.cos(L)*q,_=o.y+Math.sin(L)*q,c.lineTo(F,_),L+=H;else c.moveTo(Math.floor(o.x),Math.floor(o.y)),c.lineTo(Math.floor(o.wobbleX),Math.floor(b)),c.lineTo(Math.floor(y),Math.floor(w)),c.lineTo(Math.floor(f),Math.floor(o.wobbleY));return c.closePath(),c.fill(),o.tick<o.totalTicks}function me(c,o,g,f,b){var y=o.slice(),w=c.getContext("2d"),m,x,I=h(function(E){function z(){m=x=null,w.clearRect(0,0,f.width,f.height),d.clear(),b(),E()}function M(){n&&!(f.width===i.width&&f.height===i.height)&&(f.width=c.width=i.width,f.height=c.height=i.height),!f.width&&!f.height&&(g(c),f.width=c.width,f.height=c.height),w.clearRect(0,0,f.width,f.height),y=y.filter(function($){return ge(w,$)}),y.length?m=u.frame(M):z()}m=u.frame(M),x=z});return{addFettis:function(E){return y=y.concat(E),I},canvas:c,promise:I,reset:function(){m&&u.cancel(m),x&&x()}}}function X(c,o){var g=!c,f=!!v(o||{},"resize"),b=!1,y=v(o,"disableForReducedMotion",Boolean),w=s&&!!v(o||{},"useWorker"),m=w?A():null,x=g?ce:de,I=c&&m?!!c.__confetti_initialized:!1,E=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,z;function M(L,q,N){for(var F=v(L,"particleCount",W),_=v(L,"angle",Number),K=v(L,"spread",Number),H=v(L,"startVelocity",Number),ye=v(L,"decay",Number),we=v(L,"gravity",Number),xe=v(L,"drift",Number),te=v(L,"colors",G),Se=v(L,"ticks",Number),ne=v(L,"shapes"),ke=v(L,"scalar"),Le=!!v(L,"flat"),ie=le(L),se=F,J=[],Te=c.width*ie.x,Ce=c.height*ie.y;se--;)J.push(pe({x:Te,y:Ce,angle:_,spread:K,startVelocity:H,color:te[se%te.length],shape:ne[R(0,ne.length)],ticks:Se,decay:ye,gravity:we,drift:xe,scalar:ke,flat:Le}));return z?z.addFettis(J):(z=me(c,J,x,q,N),z.promise)}function $(L){var q=y||v(L,"disableForReducedMotion",Boolean),N=v(L,"zIndex",Number);if(q&&E)return h(function(H){H()});g&&z?c=z.canvas:g&&!c&&(c=he(N),document.body.appendChild(c)),f&&!I&&x(c);var F={width:c.width,height:c.height};m&&!I&&m.init(c),I=!0,m&&(c.__confetti_initialized=!0);function _(){if(m){var H={getBoundingClientRect:function(){if(!g)return c.getBoundingClientRect()}};x(H),m.postMessage({resize:{width:H.width,height:H.height}});return}F.width=F.height=null}function K(){z=null,f&&(b=!1,e.removeEventListener("resize",_)),g&&c&&(document.body.contains(c)&&document.body.removeChild(c),c=null,I=!1)}return f&&!b&&(b=!0,e.addEventListener("resize",_,!1)),m?m.fire(L,F,K):M(L,F,K)}return $.reset=function(){m&&m.reset(),z&&z.reset()},$}var Q;function ee(){return Q||(Q=X(null,{useWorker:!0,resize:!0})),Q}function fe(c,o,g,f,b,y,w){var m=new Path2D(c),x=new Path2D;x.addPath(m,new DOMMatrix(o));var I=new Path2D;return I.addPath(x,new DOMMatrix([Math.cos(w)*b,Math.sin(w)*b,-Math.sin(w)*y,Math.cos(w)*y,g,f])),I}function ve(c){if(!r)throw new Error("path confetti are not supported in this browser");var o,g;typeof c=="string"?o=c:(o=c.path,g=c.matrix);var f=new Path2D(o),b=document.createElement("canvas"),y=b.getContext("2d");if(!g){for(var w=1e3,m=w,x=w,I=0,E=0,z,M,$=0;$<w;$+=2)for(var L=0;L<w;L+=2)y.isPointInPath(f,$,L,"nonzero")&&(m=Math.min(m,$),x=Math.min(x,L),I=Math.max(I,$),E=Math.max(E,L));z=I-m,M=E-x;var q=10,N=Math.min(q/z,q/M);g=[N,0,0,N,-Math.round(z/2+m)*N,-Math.round(M/2+x)*N]}return{type:"path",path:o,matrix:g}}function be(c){var o,g=1,f="#000000",b='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof c=="string"?o=c:(o=c.text,g="scalar"in c?c.scalar:g,b="fontFamily"in c?c.fontFamily:b,f="color"in c?c.color:f);var y=10*g,w=""+y+"px "+b,m=new OffscreenCanvas(y,y),x=m.getContext("2d");x.font=w;var I=x.measureText(o),E=Math.ceil(I.actualBoundingBoxRight+I.actualBoundingBoxLeft),z=Math.ceil(I.actualBoundingBoxAscent+I.actualBoundingBoxDescent),M=2,$=I.actualBoundingBoxLeft+M,L=I.actualBoundingBoxAscent+M;E+=M+M,z+=M+M,m=new OffscreenCanvas(E,z),x=m.getContext("2d"),x.font=w,x.fillStyle=f,x.fillText(o,$,L);var q=1/g;return{type:"bitmap",bitmap:m.transferToImageBitmap(),matrix:[q,0,0,q,-E*q/2,-z*q/2]}}t.exports=function(){return ee().apply(this,arguments)},t.exports.reset=function(){ee().reset()},t.exports.create=X,t.exports.shapeFromPath=ve,t.exports.shapeFromText=be})(function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}}(),Y,!1);const O=Y.exports;Y.exports.create;class Ne{constructor(e){this.container=e,this.currentLang=C.getLanguage(),this.loadLessons(),this.speechRate=1,this.isRecording=!1,this.recordStartTime=null,this.spokenTranscript="",this.selectedWordInfo=null,this.render(),this.bindEvents()}loadLessons(){const e=this.currentLang==="de"?De:Be,t=C.getCustomTexts().filter(n=>!n.lang||n.lang===this.currentLang);this.lessons=[...e,...t],this.currentLesson=this.lessons[0]||e[0]}setLanguage(e){this.currentLang=e,this.loadLessons(),this.selectedWordInfo=null,this.spokenTranscript="",this.render(),this.bindEvents()}refreshCustomLessons(){this.loadLessons(),this.updateLessonDropdown()}render(){const e=this.currentLang==="de";this.container.innerHTML=`
    ...
    `,h.querySelector("#inspectAudioBtn").addEventListener("click",()=>{p.speak({text:e,rate:.85})});const d=h.querySelector("#saveWordVaultBtn");d.addEventListener("click",()=>{C.saveToVault({word:e,ipa:r,def:a,example:`${t?"Aus":"From"} "${this.currentLesson.title}"`}),d.textContent=t?"✓ Im Tresor gespeichert":"✓ Saved in Vault",d.classList.replace("btn-primary","btn-secondary"),T.playChime("tap")}),p.speak({text:e,rate:.9})}}class Fe{constructor(e){this.container=e,this.currentLang=C.getLanguage(),this.loadLessons(),this.currentLessonIdx=0,this.currentSentenceIdx=0,this.isRecording=!1,this.userAudioUrl=null,this.render(),this.bindEvents()}loadLessons(){this.lessons=this.currentLang==="de"?Pe:Ee}setLanguage(e){this.currentLang=e,this.loadLessons(),this.currentLessonIdx=0,this.currentSentenceIdx=0,this.userAudioUrl=null,this.render(),this.bindEvents()}getCurrentLesson(){return this.lessons[this.currentLessonIdx]}getCurrentSentence(){return this.getCurrentLesson().sentences[this.currentSentenceIdx]}render(){const e=this.currentLang==="de",t=this.getCurrentLesson(),n=this.getCurrentSentence(),i=t.sentences.length;this.container.innerHTML=`
      <div class="section-header">
        <div class="section-title-wrap">
      ...
      <div class="practice-card glass-panel shadowing-card">
        ...
        <div class="control-bar">
          ...
          <div style="display: flex; gap: 8px;">
            ...
            <button id="nextSentenceBtn" class="btn btn-secondary btn-sm" ${this.currentSentenceIdx===i-1?"disabled":""}>${e?"Weiter →":"Next →"}</button>
          </div>
        </div>
    ...
    `}bindEvents(){this.container.querySelector("#playAudioBtn").addEventListener("click",()=>{this.playSentence(1)}),this.container.querySelector("#playSlowDictBtn").addEventListener("click",()=>{this.playSentence(.75)}),this.container.querySelector("#dictationHintBtn").addEventListener("click",()=>{const t=this.container.querySelector("#hintBox");t.style.display=t.style.display==="none"?"block":"none"});const e=this.container.querySelector("#dictationTextarea");e.addEventListener("keydown",t=>{t.key==="Enter"&&!t.shiftKey&&!t.isComposing&&t.keyCode!==229&&(t.preventDefault(),this.checkWriting())}),this.container.querySelector("#checkWritingBtn").addEventListener("click",()=>{this.checkWriting()}),this.container.querySelector("#revealAnswerBtn").addEventListener("click",()=>{e.value=this.getCurrent().sentence,this.checkWriting()}),this.container.querySelector("#prevDictBtn").addEventListener("click",()=>{this.currentIndex>0&&(this.currentIndex--,this.render(),this.bindEvents())}),this.container.querySelector("#nextDictBtn").addEventListener("click",()=>{this.currentIndex<this.lessons.length-1&&(this.currentIndex++,this.render(),this.bindEvents())}),this.container.querySelector("#speakVerifyBtn").addEventListener("click",()=>{this.toggleSpeakVerification()})}playSentence(e=1){p.speak({text:this.getCurrent().sentence,rate:e})}checkWriting(){const e=this.currentLang==="de",t=this.container.querySelector("#dictationTextarea").value;if(!t.trim()){const l=this.container.querySelector("#diffResultsWrap"),h=this.container.querySelector("#diffDisplay");l&&h&&(l.style.display="flex",h.innerHTML=`<span style="color: #f59e0b; font-size: 14px;">${e?"⚠️ Bitte tippen Sie zuerst, was Sie gehört haben.":"⚠️ Please type what you heard first."}</span>`);return}const n=this.getCurrent().sentence,i=U.diffDictation(n,t),s=this.container.querySelector("#diffResultsWrap"),r=this.container.querySelector("#diffDisplay");s.style.display="flex";let a="";i.diff.forEach(l=>{l.type==="correct"?a+=`<span class="diff-tag correct" title="${e?"Korrekt":"Accurate"}">${l.word}</span> `:l.type==="mismatch"?a+=`<span class="diff-tag mismatch" title="${e?`Erwartet: ${l.word}`:`Expected: ${l.word}`}">${e?`Erwartet: ${l.word} (Sie schrieben: "${l.userInput}")`:`Expected: ${l.word} (You wrote: "${l.userInput}")`}</span> `:l.type==="missing"?a+=`<span class="diff-tag missing" title="${e?"Fehlt":"Missing word"}">${e?`Fehlt: ${l.word}`:`Missing: ${l.word}`}</span> `:l.type==="extra"&&(a+=`<span class="diff-tag extra" title="${e?"Überflüssig":"Extra word"}">${e?`Zusatz: "${l.word}"`:`Extra: "${l.word}"`}</span> `)}),r.innerHTML=`
      ...
      <div>${a}</div>
    `,i.isExact||i.accuracy>=90?(T.playChime("success"),O({particleCount:60,spread:50,origin:{y:.6}})):T.playChime("tap"),C.recordActivity({words:n.split(" ").length,accuracy:i.accuracy})}toggleSpeakVerification(){const e=this.currentLang==="de",t=this.container.querySelector("#speakVerifyBtn"),n=this.container.querySelector("#speakVerifyBtnText"),i=this.container.querySelector("#speakVerifyFeedback"),s=this.container.querySelector("#speakVerifyScore"),r=this.container.querySelector("#speakVerifySpoken");if(this.isSpeakingVerification){this.isSpeakingVerification=!1,t.classList.remove("recording"),n.textContent=e?"Jetzt laut sprechen":"Speak Aloud Now",p.stopListening();return}this.isSpeakingVerification=!0,t.classList.add("recording"),n.textContent=e?"Höre zu... Jetzt sprechen":"Listening... Speak now",i.style.display="none";let a="";p.startListening({lang:p.getDefaultRecognitionLang(),continuous:!0,interimResults:!0,onInterim:({full:l})=>{a=l},onResult:l=>{const h=l||a;this.isSpeakingVerification=!1,t.classList.remove("recording"),n.textContent=e?"Jetzt laut sprechen":"Speak Aloud Now";const d=U.evaluateSpeech({referenceText:this.getCurrent().sentence,spokenText:h});i.style.display="block",s.textContent=`${e?"Gesprochene Genauigkeit":"Spoken Accuracy"}: ${d.accuracy}%`,r.textContent=`${e?"Gesprochen":"Spoken"}: "${h}"`,d.accuracy>=85&&T.playChime("success")},onError:()=>{this.isSpeakingVerification=!1,t.classList.remove("recording"),n.textContent=e?"Jetzt laut sprechen":"Speak Aloud Now"}})}}class _e{constructor(e){this.container=e,this.currentLang=C.getLanguage(),this.loadScenarios(),this.currentScenarioIdx=0,this.currentStepIdx=0,this.chatHistory=[],this.isListening=!1,this.activeSelectedPrompt="",this.initScenario(),this.render(),this.bindEvents()}loadScenarios(){this.scenarios=this.currentLang==="de"?qe:Re}setLanguage(e){this.currentLang=e,this.loadScenarios(),this.currentScenarioIdx=0,this.currentStepIdx=0,this.activeSelectedPrompt="",this.initScenario(),this.render(),this.bindEvents()}getCurrentScenario(){return this.scenarios[this.currentScenarioIdx]}getCurrentStep(){return this.getCurrentScenario().steps[this.currentStepIdx]||null}initScenario(){this.currentStepIdx=0,this.chatHistory=[];const e=this.getCurrentStep();e&&(this.chatHistory.push({sender:"ai",speaker:e.speaker,avatar:e.avatar,text:e.aiSpeech}),setTimeout(()=>{p.speak({text:e.aiSpeech,rate:.95})},400))}render(){const e=this.currentLang==="de",t=this.getCurrentScenario(),n=this.getCurrentStep(),i=this.currentStepIdx>=t.steps.length;this.container.innerHTML=`
      <div class="section-header">
        <div class="section-title-wrap">
